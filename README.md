...
[Images/real-time-dashboard.mp4](https://github.com/D-Yashh/analytics/blob/main/Images/real-time-dashboard.mp4)

    
## Conclusion

The Real-Time Sales Data Analysis Application is a robust solution designed to address the challenges faced ,  Technology parts retail distributor. By leveraging the power of Spark Structured Streaming, Kafka, PostgreSQL, and Apache Superset, the application provides a seamless and efficient pipeline for processing, analyzing, and visualizing sales data in real-time.
